...
public class LouisTile : Tile
{
    ...
    public override void Start()
    {
        ...
        Dialogue louisGetMad = new Dialogue("I see. Then you should have a lots of food. Go get me some food!", "What?! (Louis feels like he is being treated as a tool by the player and don't want to talk to player anymore)", "fail_game");
